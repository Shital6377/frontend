...
axios.defaults.withCredentials = true;
    const handleSubmit = (e) =>{
        e.preventDefault()
    axios.post('https://render-backend-9zhh.onrender.com/register',{name,email,password}) //https://mern-server-api-phi.vercel.app
    .then(result =>{
        console.log(result)
        navigate('/')
    })
    ...
    return(
        <div className='d-flex justify-content-center align-items-center bg-secondary vh-100'>
           <div className='bg-white p-3 rounded w-md-25'>
            <h3>Register</h3>
